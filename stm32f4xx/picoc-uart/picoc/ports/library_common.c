...
// Определяем константы для портов и пинов
...
/// Инициализация библиотеки платформы.
void PlatformLibrarySetupEx( Picoc* pc );
void PlatformLibraryInitEx( Picoc* pc );

/// Набор функций для работы с пинами, задержками и LCD.
 ...
 * 
 * @param Parser		Указатель на состояние парсера.
 * @param ReturnValue	Указатель на возвращаемое значение.
 * @param Param 		Указатель на массив параметров.
 * @param NumArgs 		Количество аргументов.
 */
void CpinMode( struct ParseState* Parser, struct Value* ReturnValue, struct Value** Param, int NumArgs )
{
    // Устанавливаем режим и значение пина.
...
/**
 * @brief 	Библиотека платформы.
 * 
 * Эта библиотека содержит функции для работы с пинами, задержками и LCD.
 */
...
/**
 * @brief 	Инициализация библиотеки платформы.
 * 
 * @param pc	Указатель на экземпляр Picoc.
 */
void PlatformLibrarySetup( Picoc* pc )
{
    // Регистрация библиотеки платформы.
