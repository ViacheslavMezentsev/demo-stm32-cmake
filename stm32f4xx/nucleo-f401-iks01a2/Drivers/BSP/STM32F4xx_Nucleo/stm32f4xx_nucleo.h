 ...
 */
/**
 * @brief Definition for COM portx, connected to USART6
 */

#define BUS_USART6_INSTANCE USART6
#define BUS_USART6_TX_GPIO_AF GPIO_AF8_USART6
#define BUS_USART6_TX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE()
#define BUS_USART6_TX_GPIO_PORT GPIOC
#define BUS_USART6_TX_GPIO_PIN GPIO_PIN_6
#define BUS_USART6_TX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
#define BUS_USART6_RX_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
#define BUS_USART6_RX_GPIO_CLK_DISABLE() __HAL_RCC_GPIOC_CLK_DISABLE()
#define BUS_USART6_RX_GPIO_PIN GPIO_PIN_7
#define BUS_USART6_RX_GPIO_AF GPIO_AF8_USART6
#define BUS_USART6_RX_GPIO_PORT GPIOC
